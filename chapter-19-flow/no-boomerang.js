// callbacks using named functions.  No pyramid of doom (boomerang) code but it is still
// far too hard to follow
...
function append_a_to_b(callback) {
    ...
    open_a();  // only function call called directly from append_a_to_b()
}

console.log('starting...');

append_a_to_b(function(err){
    if (err) {
        throw err;
    }
